...
QT_MOC_LITERAL(1, 12, 10), // "ReadyImage"
...
QT_MOC_LITERAL(8, 72, 22), // "DownloadedImageHandler"
QT_MOC_LITERAL(9, 95, 14), // "QNetworkReply*"
QT_MOC_LITERAL(10, 110, 5), // "reply"
QT_MOC_LITERAL(11, 116, 24) // "WeatherDownloadedHandler"

    },
    "HTTPManager\0ReadyImage\0\0QPixmap*\0map\0"
    "WeatherJsonReady\0QJsonObject*\0json\0"
    "DownloadedImageHandler\0QNetworkReply*\0"
...
void HTTPManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ReadyImage((*reinterpret_cast< QPixmap*(*)>(_a[1]))); break;
        case 1: _t->WeatherJsonReady((*reinterpret_cast< QJsonObject*(*)>(_a[1]))); break;
        case 2: _t->DownloadedImageHandler((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HTTPManager::ReadyImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HTTPManager::ReadyImage(QPixmap * _t1)
{
